import logging 
 ...
 telethn = TelegramClient("bholu", API_ID, API_HASH) 
  
 pbot = Client("TrickyHeaven", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN,in_memory=True) 
 ...
 from TrickyHeaven.modules.helper_funcs.handlers import ( 
